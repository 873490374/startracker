...
NVIDIA Jetson TX2 seems to be good candidate to be used in space as the startracker hardware, however not for CubeSats due to their low power budget. It could be used in little larger satellites, like in HyperSat. Jetson's low power consumption and GPU give possibility to create new startracker without spending time and resources on hardware part, but only on software.
