...
%================GLOSSARY=================%
%\newglossaryentry{Centroid}{type=glossary, name=centroid, description={Is a mark up language specially suited for scientific documents}
%\newglossaryentry{Star ID}{type=glossary, name=starid, description={Is a mark up language specially suited for scientific documents}
