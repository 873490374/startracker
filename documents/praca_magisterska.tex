...
TODO FULL STARTRACKER block diagram
Testing\par
...
star_0_Hipparcos_ID, star_1_Hipparcos_ID, star_2_Hipparcos_ID, area, polar_moment, k_ID
...
The catalog has following columns:
star_Hipparcos_ID, unit_vector_0, unit_vector_1, unit_vector_2
...
Computational complexity is $O(n^3+n^2)$, where $n$ is number of star vectors.
...
Time complexity is $O(n)$, where $n$ is number of star vectors.

No block diagram will be presented for this part of the program, because it is just calculating using equations in previous chapter.
...
\item get better values for sigm, sigx,
