...
\item generating star catalogue (not started yet)
\item connecting all the elements into one program (will be started after all the other elements are finished)
\end{enumerate}
Testing\par
