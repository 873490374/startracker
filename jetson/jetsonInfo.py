...
if os.path.exists('/etc/nv_tegra_release'):
    ...
    for entry in l4tVersionInfo:
        if 'release' in entry:
            ...
            board = entry.split(' ')[2]
    print(' L4T ' + str(l4tRelease) + '.' + l4tRevision + " [ JetPack " +
          os.environ["JETSON_JETPACK"].strip() + " ]")
    print(' Board: ' + board)
else:
    print(
        terminalColors.FAIL + "Error: Unable to find L4T Version" + terminalColors.ENDC)
...
if os.path.exists('/etc/os-release'):
    ...
    print(
        terminalColors.FAIL + "Error: Unable to find Ubuntu Version" + terminalColors.ENDC)
...
if os.path.exists('/proc/version'):
    ...
    print(
        terminalColors.FAIL + "Error: Unable to find Linux kernel version" + terminalColors.ENDC)
